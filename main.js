...
var $author$project$FancyForms$Form$fieldWithVariants = F6(
	function (extractDefault_, variantSelector, defaultVariant, otherVariants, extractVariantName, _v0) {
		var fn = _v0.fn;
		var count = _v0.count;
		var updates = _v0.updates;
		var fieldWithErrors = _v0.fieldWithErrors;
		...
		return {
			...
			initWithData: A2(
				$author$project$FancyForms$Form$extendInit,
				initWithData,
				A4($author$project$FancyForms$Form$extractVariantInit, variantsWithWidgets, fieldId, extractDefault_, extractVariantName)),
			isConsistent: A2(
				$author$project$FancyForms$Form$extendConsistencyCheck,
				isConsistent,
				A2($author$project$FancyForms$Form$extractConsistencyCheck, widget, fieldId)),
